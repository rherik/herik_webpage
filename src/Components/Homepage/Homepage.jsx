...
export default function Homepage() {
  ...
  return (
    <main className='flex flex-col items-center bg-[#F2F0EA] dark:bg-gray-900' id='home'>
        ...
        <div className='w-80 md:w-[980px] pt-20 md:pl-8'>
          ...
          <div className='flex md:flex-row flex-col justify-around pt-8 pl-8 space-y-3' id='divImage'> 
            <img src={imgs[0]} alt="" className='w-64 rounded-lg translate-x-[-600px] opacity-0' id='img1' />
            <img src={imgs[1]} alt="" className='w-64 rounded-lg translate-x-[600px] opacity-0' id='img2' />
          </div>
